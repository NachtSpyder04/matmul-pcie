...
proc create_root_design { parentCell } {
  ...
  # Create instance: matmul_axis_wrapper_0, and set properties
  set block_name matmul_axis_wrapper
  set block_cell_name matmul_axis_wrapper_0
  if { [catch {set matmul_axis_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $matmul_axis_wrapper_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.n {8} $matmul_axis_wrapper_0
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS] [get_bd_intf_pins matmul_axis_wrapper_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net matmul_axis_wrapper_0_M_AXIS [get_bd_intf_pins matmul_axis_wrapper_0/M_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net xdma_0_M_AXIS_H2C_0 [get_bd_intf_pins xdma_0/M_AXIS_H2C_0] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  ...
  [get_bd_pins matmul_axis_wrapper_0/clk]
  ...
  [get_bd_pins matmul_axis_wrapper_0/rst_n]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_ports pcie_clkreq_l]
